...
import
  com.LojaDeGames.Games.model.Produto;
import
  com.LojaDeGames.Games.repository.ProdutoRepository;
 ...
 // public ResponseEntity<List<Categoria>> getByNome(@PathVariable String produto){ 
